    ...
    <li>
       ...
       <li>
            ...
            <label>
            <!--<div class="list">-->
            <input class="qwe" type="radio" name="type_order_edit" id="type_order_edit" value="0"/>Выполнен
			<br>
			<input class="qwe" type="radio" name="type_order_edit" id="type_order_edit" value="1"/>В процессе...
            </label>     
        </li>
    </ul>
			<div class="block"></div>
